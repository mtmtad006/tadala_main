...
## Generated on : Sun Oct 26 22:36:55 2025
...
DEFINES_STANDARD = -DMODEL=MicroMouse_Deploy -DNUMST=2 -DNCSTATES=24 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MicroMouse_Deploy.c.o MicroMouse_Deploy_data.c.o rtGetInf.c.o rt_nonfinite.c.o IMU.c.o Motors.c.o SSD1306.c.o VL53L0X.c.o ADCs.c.o Buttons.c.o LEDs.c.o INA219.c.o preformatted_flash.c.o overrideHALDelay.c.o platform_timer.c.o SysTickScheduler.c.o m3m4m4f_multitasking.c.o main.c.o stm32l4xx_it.c.o stm32l4xx_hal_msp.c.o stm32l4xx_hal_timebase_tim.c.o stm32l4xx_hal_tim.c.o stm32l4xx_hal_tim_ex.c.o stm32l4xx_hal_adc.c.o stm32l4xx_hal_adc_ex.c.o stm32l4xx_hal.c.o stm32l4xx_hal_rcc.c.o stm32l4xx_hal_rcc_ex.c.o stm32l4xx_hal_flash.c.o stm32l4xx_hal_flash_ex.c.o stm32l4xx_hal_flash_ramfunc.c.o stm32l4xx_hal_gpio.c.o stm32l4xx_hal_i2c.c.o stm32l4xx_hal_i2c_ex.c.o stm32l4xx_hal_dma.c.o stm32l4xx_hal_dma_ex.c.o stm32l4xx_hal_pwr.c.o stm32l4xx_hal_pwr_ex.c.o stm32l4xx_hal_cortex.c.o stm32l4xx_hal_exti.c.o stm32l4xx_hal_uart.c.o stm32l4xx_hal_uart_ex.c.o system_stm32l4xx.c.o syscalls.c.o sysmem.c.o startup_stm32l476vetx.s.o code_profiling_utility_functions.c.o
...
rtGetInf.c.o : $(START_DIR)/MicroMouse_Deploy_ert_rtw/instrumented/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
