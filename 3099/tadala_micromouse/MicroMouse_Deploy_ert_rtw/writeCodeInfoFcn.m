% Autogenerated file: Sat Sep 13 18:27:11 2025
...
wr.fFullModel.componentInterface.Parameters;
    ...
    CodeDescType_44_R0_V0_C0.BaseType   = CodeDescType_0_R0_V0_C0;
    ...
    % Matrix Type
    CodeDescType_42_R0_V0_C0 = coder.descriptor.types.Matrix(wr.fMF0Model);
    CodeDescType_42_R0_V0_C0.BaseType   = CodeDescType_1_R0_V0_C0;
        CodeDescType_42_R0_V0_C0.Dimensions = [1,1];
            CodeDescType_42_R0_V0_C0.updateSymbolicPropertiesToMatchDims();
    ...
    % Matrix Type
    CodeDescType_53_R0_V0_C0 = coder.descriptor.types.Matrix(wr.fMF0Model);
    CodeDescType_53_R0_V0_C0.BaseType   = CodeDescType_3_R0_V0_C0;
        CodeDescType_53_R0_V0_C0.Dimensions = [1,1];
            CodeDescType_53_R0_V0_C0.updateSymbolicPropertiesToMatchDims();
    ...
    func_OutputUpdate_Prototype = coder.descriptor.types.Prototype(wr.fMF0Model);
            addValuesToSequence(func_OutputUpdate_Prototype.Arguments, tmpArgs);

    func_OutputUpdate_Prototype.Return     = tmpRet;

        func_OutputUpdate_Prototype.HeaderFile = 'MicroMouse_Deploy.h';
    func_OutputUpdate_Prototype.SourceFile = 'MicroMouse_Deploy.c';

    func_OutputUpdate_Interface = coder.descriptor.FunctionInterface(wr.fMF0Model);
    func_OutputUpdate_Interface.Prototype    = func_OutputUpdate_Prototype;
            addValuesToSequence(func_OutputUpdate_Interface.ActualArgs, tmpActualArgs);

    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;

            func_OutputUpdate_Prototype.Name = 'MicroMouse_Deploy_step';
    time_0 = wr.fFullModel.componentInterface.TimingProperties(getIndexFromTimingInternalId(wr.fFullModel.componentInterface.TimingInternalIds, 0));
        func_OutputUpdate_Interface.Timing = time_0;

                addValuesToSequence(wr.fFullModel.componentInterface.OutputFunctions, func_OutputUpdate_Interface');
    ...
    Type_42_R0_V0_C0.BaseType   = Type_1_R0_V0_C0;
        Type_42_R0_V0_C0.Dimensions = [1,1];
    ...
    Type_53_R0_V0_C0.BaseType   = Type_3_R0_V0_C0;
        Type_53_R0_V0_C0.Dimensions = [1,1];
    ...
    func_OutputUpdate_Prototype = coder.types.Prototype;
            func_OutputUpdate_Prototype.Arguments = [func_OutputUpdate_Prototype.Arguments tmpArgs];
    ...
    func_OutputUpdate_Interface.Prototype    = func_OutputUpdate_Prototype;
            func_OutputUpdate_Interface.ActualArgs = [func_OutputUpdate_Interface.ActualArgs tmpActualArgs];
